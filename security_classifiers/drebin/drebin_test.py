...
def _main():
    ...
    if args.smooth == 'hash':
        ...
        train_x_y, val_x_y, test_x_y = (train_x, train_x_y[1]), (val_x, val_x[1]), (test_x, test_x[1])
    ...
    # train
    train_model(train_x_y_producer, val_x_y_producer, epochs=args.epochs, learning_rate=args.lr, device=device,
                verbose=True)
